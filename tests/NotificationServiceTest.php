...
class NotificationServiceTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function getByCodeShouldDoAGetRequestAddingCredentialsData()
    {
        ...
        $this->client->expects($this->once())
                     ->method('get')
                     ->with('https://ws.pagseguro.uol.com.br/v2/transactions/notifications/1?email=a@a.com&token=t')
                     ->willReturn($xml);
        ...
        $service = new NotificationService($this->credentials, $this->client, $this->decoder);
