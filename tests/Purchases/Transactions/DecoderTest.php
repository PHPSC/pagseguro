...
class DecoderTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testDecodeShouldDoReturningTransactionWithoutShipping()
    {
        $detailsDate = new DateTime('2011-02-10T16:13:41.000-03:00');
        $detailsLastEventDate = new DateTime('2011-02-10T19:15:11.000-03:00');
        $customer = new Customer('usuario@site.com', 'FooBar', new Phone('11', '99999999'));
        $details = new Details('9E884542', 'REF1234', '6', $detailsDate, $detailsLastEventDate, $customer);
        ...
        $transaction = new Transaction($details, $payment, 2, $items);

        $obj = simplexml_load_file(__DIR__.'/xml/transactionWithoutShipping.xml');
        $decoder = new Decoder;
        $this->assertEquals($transaction, $decoder->decode($obj));
    }
}
